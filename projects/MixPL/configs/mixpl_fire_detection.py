...
data_root_sup = '/dev/shm/data/voc_fire/VOCdevkit/'
data_root_unsup = '/dev/shm/data/fire_unlabeled/VOCdevkit/'
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root_sup + 'annotations/voc07_val.json',
    metric='bbox',
    format_only=False)
